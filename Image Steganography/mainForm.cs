...
namespace IMG_Stego
{
    public partial class FormStego : Form
    {
        ...
        {
            string app = "Network Security Assignment v2.0";
            string author = "Malith Wijesekara ";
            string year = " 2019 ";
            string email = "malith.sandagiri@outlook.com";
        ...
        private void GroupBoxPlainText_Enter(object sender, EventArgs e)
        {
